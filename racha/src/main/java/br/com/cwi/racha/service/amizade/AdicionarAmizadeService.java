...
@Service
public class AdicionarAmizadeService {
    ...
    @Transactional
    public void confirmar(Long idUsuario, Long idSolicitacaoUsuario) {
        ...
        seSaoAmigosValidator.validarSolicitacaoExistente(usuario.getSolicitacoes(), solicitante);

        usuario.adicionarAmizade(solicitante);
